# Revised from http://heatmapping.org/tutorial/
...
# --------------------------------------------------------------
# convert VGG/ResNet's dense layers to convolutional layers
# --------------------------------------------------------------
class UnFlatten(nn.Module):
    def __init__(self, h, w):
        ...
        self.w = w
    def forward(self, x):
        return x.view(x.size()[0], 512, self.h, self.w)

def dense2conv(layers, is_vgg=True):
    newlayers = []
